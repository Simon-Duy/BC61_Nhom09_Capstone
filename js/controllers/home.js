...
function getAttributeGiay(arrGiay) {
    ...
    // let arrProductImg = document.querySelectorAll(".product-items > div a img, .product-items > div #price");

    // Lệnh thay thế cho dòng thứ 37. Nếu không có dòng thứ 37, hãy bỏ ghim đoạn Code dưới và trên. Code dùng để gắn Hình ảnh Sản phẩm từ Back-End lên giao diện

    // arrProductImg.forEach((item, index) => {
    //     let giayImg = arrGiay[index];
    //     item.src = giayImg.image;
    // });
